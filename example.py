from quran_nlp import QuranContextToWords
...
plt.subplot(211)
word = 'الجنة'
contextToWords.print_similar_word_cloud(word, 'test1.png', 20)

plt.subplot(212)
word = 'الله'
contextToWords.print_similar_word_cloud(word, 'test2.png', 20)
